...
This script makes parallel API calls to OpenAI o4-mini, Gemini 2.5 Pro, and DeepSeek Reasoner 
...
class CouncilConsultation:
    ...
    def read_context_file(self, file_path: str) -> str:
        ...
        try:
            ...
            print(f"✓ Loaded context file: {file_path} ({len(content)} characters)")
            return content
...
{full_content}"""
    ...
    def call_openai_o3(self, content: str) -> str:
        ...
        try:
            print("🤖 Consulting OpenAI o4-mini...")
...
{content}"""
    ...
    def call_gemini_pro(self, content: str) -> str:
        ...
        try:
            print("🧠 Consulting Gemini 2.5 Pro...")
...
when appropriate."""),
    ...
    def call_deepseek_reasoner(self, content: str) -> str:
        ...
        try:
            print("🧮 Consulting DeepSeek Reasoner...")
...
Be methodical, analytical, and provide step-by-step reasoning when appropriate."""
    ...
    def run_parallel_consultation(self, content: str) -> Tuple[str, str, str]:
        ...
        print("\n🏛️  Convening the Council of AI Specialists...\n")
...
{'='*80}
🏛️  COUNCIL OF AI SPECIALISTS - CONSULTATION REPORT
{'='*80}
Timestamp: {timestamp}
...
Examples:
  ...
  python council.py --context-file "docs/design.md" --context "Legacy system" --prompt "Migration strategy?"
    ...
    try:
        ...
        print("\n✅ Council consultation completed successfully!")
